...
language.Add("Cleanup_smhentity", "Movie Entities")
language.Add("Cleaned_smhentity", "Cleaned up all Movie Entities")
language.Add("SBoxLimit_smhentity", "You've hit the Movie Entity limit!")
language.Add("max_smhentity", "Max Movie Entities:")
